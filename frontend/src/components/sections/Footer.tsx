      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            ...
            <p className="mt-4 text-sm text-gray-600 max-w-xs">
              Empowering individuals to monitor, understand, and improve their cardiovascular health through technology and expert guidance.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-4">
              <li>
                <Link to="/predictor" className="text-base text-gray-600 hover:text-gray-900">
                  Heart Disease Predictor
                </Link>
              </li>
              <li>
                <Link to="/appointments" className="text-base text-gray-600 hover:text-gray-900">
                  Doctor Consultations
                </Link>
              </li>
              <li>
                <Link to="/hospitals" className="text-base text-gray-600 hover:text-gray-900">
                  Hospital Finder
                </Link>
              </li>
              <li>
        ...
        <div className="mt-12 pt-8 border-t border-gray-200 flex flex-col md:flex-row justify-between items-center">
          <p className="text-base text-gray-500">
            &copy; {currentYear} HeartHealth. All rights reserved.
          </p>
