...
import { ToastProvider as UIToastProvider, Toaster as UIToaster } from './components/ui/use-toast'
...
import { useUserRole, getUserRole } from './hooks/useAuth'
import { useAuth } from './hooks/useAuth'
import NotFound from './pages/NotFound'
import type { ReactNode } from 'react'

// Simple toast provider for notifications
...
// A simple Toaster component for displaying notifications
const Toaster = () => {
  return null;
};
...
const HomePage = () => {
  ...
  const isDoctor = userRoleData?.role === 'doctor' || 
                  (user && user.userType === 'doctor' ? true : false);
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <Routes>
        ...
        <Route path="/predictor" element={<HeartDiseasePredictor />} />
